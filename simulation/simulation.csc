...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype470</identifier>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/IoT_Project/sensors/temp_sensor/temp_sensor.c</source>
      <commands>make temp_sensor.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>28.298632202425587</x>
        <y>9.473348435993799</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype470</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>50.78265944141579</x>
        <y>47.52933080400187</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.496500558989482 0.0 0.0 1.496500558989482 147.17510411387667 53.52324087222026</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
