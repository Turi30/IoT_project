...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/IoT_project/sensors and actuators/temp_sensor/temperature_node.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/IoT_project/sensors and actuators/temp_sensor/humidity_node.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/IoT_project/sensors and actuators/temp_sensor/dishwasher_node.c</source>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>47.3553733719939</x>
        <y>74.57325720298803</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>28.49846469689827</x>
        <y>94.22827774495255</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.131326393427295 0.0 0.0 2.131326393427295 127.13018020942563 1.0382684390751795</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
